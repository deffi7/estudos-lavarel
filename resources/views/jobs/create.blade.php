<x-layout>
    ...
    <div class="space-y-12">
        ...
        <h2 class="text-base/7 font-semibold text-gray-900">Crie um novo emprego</h2>
        <p class="mt-1 text-sm/6 text-gray-600">Adicione um novo emprego à lista.</p>
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="mt-2">
                ...
                <input id="title" type="text" name="title" placeholder="Repositor" class="block min-w-0 grow bg-white py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" required/>
                </div>
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="mt-2">
                <div class="flex items-center rounded-md bg-white pl-3 px-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                <input id="salary" type="text" name="salary" placeholder="R$10,000 por ano." class="block min-w-0 grow bg-white py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" required/>
                </div>
